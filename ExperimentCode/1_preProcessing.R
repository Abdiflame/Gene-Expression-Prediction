...
#LOAD DATASET
snp <- read.vcfR("Downloads/GEUVADIS.chr11.PH1PH2_465.IMPFRQFILT_BIALLELIC_PH.annotv2.genotypes.vcf")
...
write.table(snp_loc, "snp_loc22.txt")
write.table(snp_inf, "snp_inf22.txt")
